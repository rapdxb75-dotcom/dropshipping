  ...
  return (
    <div className="container section">
      ...
      <div className="section-sub" style={{ textAlign: 'left', margin: '0' }}>
        <p><strong>1. Processing Time</strong><br/>All orders are processed within 1 to 2 business days (excluding weekends and holidays) after receiving your order confirmation email.</p>
        <br/>
        <p><strong>2. Shipping Rates & Estimates</strong><br/>We offer <strong>Free Standard Shipping</strong> (2–5 business days) on all bundles within the United States. For single item orders, standard shipping rates apply and will be calculated at checkout.</p>
        <br/>
